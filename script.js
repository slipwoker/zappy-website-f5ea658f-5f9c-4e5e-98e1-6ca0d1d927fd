document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function showError(input, message) {
            ...
            error.style.cssText = 'color: #d32f2f; font-size: 0.85em; margin-top: 4px; display: block;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f5ea658f-5f9c-4e5e-98e1-6ca0d1d927fd',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f5ea658f-5f9c-4e5e-98e1-6ca0d1d927fd';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f5ea658f-5f9c-4e5e-98e1-6ca0d1d927fd';
